...
namespace AbstractEngine.Core.Base
{
    ...
    public static class InputManger
    {
        ...
        public static VirtualKeys _keyDown = VirtualKeys.Noname,
    ...
    internal class GlobalKeyboardHook : IDisposable
    {
        ...
        public GlobalKeyboardHook()
        {
            ...
            _user32LibraryHandle =
                LoadLibrary(
                    "User32"); // we must keep alive _hookProc, because GC is not aware about SetWindowsHookEx behaviour.
        ...
        public struct LowLevelKeyboardInputEvent
        {
            ...
            /// </summary>
            public VirtualKeys Key => (VirtualKeys) VirtualCode;

            private readonly int VirtualCode;
